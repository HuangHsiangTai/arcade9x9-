controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    buttonA.sprite.setImage(img`
        ...
        ........ffffffffffffffff........
        `)
    if (buttonA.m.getAnswer() == m1.getAnswer()) {
        info.player1.changeScoreBy(1)
        starA = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . b . . . . . . . 
            . . . . . . . b d b . . . . . . 
            . . . . . . b 5 5 5 b . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, buttonA.sprite, randint(-100, 100), randint(-50, -100))
    } else {
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    buttonB.sprite.setImage(img`
        ...
        ....887666666888888666666788....
        ....866666668877777866666678....
        ...88666666687766668766666688...
        ...88666666888888888766666688...
        ...88666666877777778886666688...
        ...88666668866666667788666688...
        ..cc866666866666666667866668cc..
        .ccbc8666688666666666886668cbcc.
        .fcbcc86666688888888887668ccbcf.
        .fcbbcc886666666666666688ccbdcf.
        .f8bbbccc88888888888888cccbddcf.
        .f8cbbbbccccccccccccccccbdddbcf.
        .f8ccbbbbbccccccccccccb11dddccf.
        ...
        ........ffffffffffffffff........
        `)
    if (buttonB.m.getAnswer() == m1.getAnswer()) {
        info.player1.changeScoreBy(1)
        starB = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . b . . . . . . . 
            . . . . . . . b d b . . . . . . 
            . . . . . . b 5 5 5 b . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, buttonB.sprite, randint(-100, 100), randint(-50, -100))
    } else {
        info.player1.changeLifeBy(-1)
        scene.cameraShake(4, 500)
    }
...
controller.B.onEvent(ControllerButtonEvent.Released, function () {
    buttonB.sprite.setImage(img`
        ...
        ........6667777777777666........
        ......66677777777777777666......
        .....6677777788888887777766.....
        ....667777777897779877777766....
        ....677777777897779877777776....
        ...66777777778977789777777766...
        ...66777777778888888977777766...
        ...88777777798777778897777788...
        ...88777777798777777987777788...
        ...88977777778777777987777988...
        ...88977777778777777987777988...
        ...88997777778899999987779988...
        ...88799777777888888887777788...
        ...88679997777777777779777688...
        ..cc866679999999999999976668cc..
        .ccbc6666679999999999766666cbcc.
        .fcbcc66666666666666666666ccbcf.
        .fcbbcc666666666666666666ccbdcf.
...
function updateQuestion () {
    m1.updateXY(randint(1,9),randint(1,9))
m2.updateXY(randint(1,9),randint(1,9))
monkey.setMultiplier(m1)
monkey.say(`${m1.x}x${m1.y}=?`)
if (randint(0, 1)) {
        buttonA.setMultiplier(m1)
buttonB.setMultiplier(m2)
    } else {
        buttonA.setMultiplier(m2)
buttonB.setMultiplier(m1)
    }
    buttonA.showAnswer()
buttonB.showAnswer()
}
let starB: Sprite = null
let starA: Sprite = null
let mySprite = null
class Multiplier {
    x: number
    y: number
...
class Role {
    ...
    showAnswer() {
        this.sprite.say(this.m.getAnswer())
    }
    setPosition(x:number, y:number) {
        this.sprite.setPosition(x,y)
    }
    say(text:string) {
        this.sprite.say(text)
    }
}
let buttonA = new Role()
let buttonB= new Role()
let monkey = new Role()
let m1 = new Multiplier()
let m2 = new Multiplier()
scene.setBackgroundImage(img`
    ...
    `)
monkey.sprite = sprites.create(img`
    . . . . f f f f f . . . . . . . 
    . . . f e e e e e f . . . . . . 
    . . f d d d d e e e f . . . . . 
    ...
    . . . . f f f f f f f f f . . . 
    `, SpriteKind.Player)
monkey.sprite.setPosition(80, 99)
buttonA.sprite = sprites.create(img`
    ..........666666666666..........
    ........6667777777777666........
    ......66677777777777777666......
    .....6677777779999777777766.....
    ...
    ........ffffffffffffffff........
    `, SpriteKind.Player)
buttonA.setPosition(127, 97)
buttonB.sprite = sprites.create(img`
    ..........666666666666..........
    ........6667777777777666........
    ......66677777777777777666......
    .....6677777788888887777766.....
    ...
    ........ffffffffffffffff........
    `, SpriteKind.Player)
buttonB.setPosition(44, 99)
game.splash("Anwser the question", "with A,B button")
info.setLife(3)
updateQuestion()
